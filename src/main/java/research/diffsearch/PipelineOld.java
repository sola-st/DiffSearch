...
//        private volatile JavascriptTree tree_query;
...
//
//        public Final_Matching(String candidate, String info, JavascriptTree tree_query, String[] array_query_old_nodes, String[] array_query_new_nodes, BufferedWriter buff_writer_features) {
...
//
//            JavascriptTree change = new JavascriptTree(candidate.replace("$$", "\n"));
//            //  Python3_Tree change = new Python3_Tree(candidate.replace("$$", "\n"));
//
//            List<String> list_change_nodes = new ArrayList<>();
//            TreeUtils.query_extraction_nodes(change.getParsetree(), Arrays.asList(change.getParser().getRuleNames()), list_change_nodes);
//
...
//                equal = TreeUtils.deep_tree_comparison_javascript2(tree_query.getParsetree(),
//                        Arrays.asList(tree_query.getParser().getRuleNames()),
//                        change.getParsetree(),
//                        Arrays.asList(change.getParser().getRuleNames()),
//                        writer);
//            } catch (Exception e) {
//
//                return;
...
//
//
//                TreeUtils.query_leaves_extraction(change.getParsetree(), Arrays.asList(change.getParser().getRuleNames()), list_change_old_leaves);
//
//
...
//     */
//    public static long final_matching(JavaTree tree_query) {
...
//            JavaTree change = new JavaTree(candidate.replace("$$", "\n"));
//            //  Python3_Tree change = new Python3_Tree(candidate.replace("$$", "\n"));
//            //Computing hash sum of changes
//            List<Integer> list_change_hash_sum = new ArrayList<Integer>();
//            List<String> ruleNamesList2 = Arrays.asList(change.getParser().getRuleNames());
//            TreeUtils.tree_hash_sumAST_java(change.getParsetree(), ruleNamesList2, list_change_hash_sum, change.features);
//
//            //Computing list change parent child
//            List<Integer> list_change_parent_child = new ArrayList<Integer>();
//            TreeUtils.pairs_parent_childAST_java(change.getParsetree(), ruleNamesList2, list_change_parent_child, change.features);
//
...
//     * @return number of matching changes found
//     */
//    public static long final_comparison(JavaTree tree_query, long change_number, Tree query_old, Tree query_new, BufferedWriter buff_writer_results, String query_string) {
...
//        TreeUtils.query_extraction_nodes(tree_query.getParsetree(), Arrays.asList(tree_query.getParser().getRuleNames()), list_query_nodes);
//
//        List<String> list_query_old_leaves = new ArrayList<>();
//        List<String> list_query_new_leaves = new ArrayList<>();
//
//        TreeUtils.query_leaves_extraction(tree_query.getParsetree(), Arrays.asList(tree_query.getParser().getRuleNames()), list_query_old_leaves);
//
//        boolean new_code = false;
//
...
//                    equal2 = TreeUtils.deep_tree_comparison_partial(query_old, Arrays.asList(tree_query.getParser().getRuleNames()), change.getParsetree().getChild(0), Arrays.asList(change.getParser().getRuleNames()), writer, false, candidate.replace("$$", "\n"));
//                    equal3 = TreeUtils.deep_tree_comparison_partial(query_new, Arrays.asList(tree_query.getParser().getRuleNames()), change.getParsetree().getChild(2), Arrays.asList(change.getParser().getRuleNames()), writer, false, candidate.replace("$$", "\n"));
//                }
//                //  equal = TreeUtils.deep_tree_comparison_python(tree_query.get_parsetree(), Arrays.asList(tree_query.get_parser().getRuleNames()), change.get_parsetree(), Arrays.asList(change.get_parser().getRuleNames()), writer);
...
//                equal = TreeUtils.deep_tree_comparison_java(tree_query.getParsetree(), Arrays.asList(tree_query.getParser().getRuleNames()), change.getParsetree(), Arrays.asList(change.getParser().getRuleNames()), writer);
//
//            } catch (Exception e) {
//
//                continue;
...
//     * @return number of matching changes found
//     */
//    public static long final_comparison_multithreading(JavascriptTree tree_query, long change_number, Tree query_old, Tree query_new, BufferedWriter buff_writer_results) {
//        try {
//            BufferedWriter buff_writer_features = null;
//            try {
//                Writer writer =
