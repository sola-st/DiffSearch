...
//     * @return A list of changes in the form: old code -> new code
//     */
//    public static long analyze_diff_file_fixed() {
//        List<String> temporary_list_old = new ArrayList<String>();
//        List<String> temporary_list_new = new ArrayList<String>();
//        long change_number = 0;
//        List<String> allLines = null;
...
//    }
//
//    public static boolean clone_GitHub_repositories(){
//
//        try {
//            Git git = Git.cloneRepository()
//                    .setURI( "https://github.com/Activiti/Activiti.git" )
//                    .setDirectory(new File(Config.repositoryPath))
//                    .call();
